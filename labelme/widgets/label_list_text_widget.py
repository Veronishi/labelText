...
class HTMLDelegate(QtWidgets.QStyledItemDelegate):
    ...
    def sizeHint(self, option, index):
        ...
        return QtCore.QSize(
            self.doc.idealWidth(),
            self.doc.size().height() - constant,
        )


class LabelListTextWidgetItem(QtGui.QStandardItem):
    def __init__(self, text=None, shape=None):
        super(LabelListTextWidgetItem, self).__init__()
        self.setText(text)
        self.setShape(shape)
    ...
    def clone(self):
        return LabelListTextWidgetItem(self.text(), self.shape())
...
class LabelListTextWidget(QtWidgets.QListView):

    itemDoubleClicked = QtCore.Signal(LabelListTextWidgetItem)
    itemSelectionChanged = QtCore.Signal(list, list)

    def __init__(self):
        super(LabelListTextWidget, self).__init__()
        self._selectedItems = []
    ...
    def addItem(self, item):
        if not isinstance(item, LabelListTextWidgetItem):
